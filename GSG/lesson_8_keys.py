...
class lesson_8_keys(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "lesson_8_keys")
        ...
        self._freq_range = qtgui.Range(300e6, 400e6, 100, 310e6, 200)
...
def main(top_block_cls=lesson_8_keys, options=None):
